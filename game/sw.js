...
var version = "1.1.9",
  ...
  spineFiles = [
    ...
    "spine/checkpointEnd/skeleton2.png",
    ...getSpineFiles("countdownResume"),
    ...getSpineFiles("countdownStart"),
    ...getSpineFiles("demonBoss", "boss_anima"),
    ...getSpineFiles("demonBossFireball"),
    "spine/demonBossFist/fist_collision.json",
    ...getSpineFiles("demonBossMinion", "minion"),
    ...getSpineFiles("demonBossPlayerHit", "Player"),
    ...getSpineFiles("directionChange"),
    ...getSpineFiles("directionChangeHit"),
    ...getSpineFiles("doubleJump"),
    ...getSpineFiles("doubleJumpOnPlayer"),
    ...getSpineFiles("endOfLevel"),
    ...getSpineFiles("flyingFlag", "Flag1"),
    ...getSpineFiles("pixelPortal", "Portal2"),
    ...getSpineFiles("portal", "Portal2"),
    ...getSpineFiles("robotBoss"),
    ...getSpineFiles("sizeButton", "Switch_button"),
    ...getSpineFiles("skateboard", "skateboard"),
    ...getSpineFiles("speedBoost", "speed_boost_animation"),
    ...getSpineFiles("spring"),
  ];
